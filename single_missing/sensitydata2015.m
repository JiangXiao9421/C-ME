clear;clc;
load KNN2015;load ourdata2015;load Kmeanserrordata2015;load lowrank2015_40
...
meany1=[7.5215,7.5215];
hotdecky2=[6.7918,6.7918]; %the error of hotdeck 
regressy3=[6.3941,6.3941];
lowranky4=error';
